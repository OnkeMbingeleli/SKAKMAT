...
<style>
body[data-page="admin-emergency"] .page-content { padding-top: 34px; }
body[data-page="admin-emergency"] .cm-hero,
body[data-page="admin-emergency"] .cm-emg-banner,
body[data-page="admin-emergency"] #rollCallCard {
    width: min(1180px, 100%);
    margin-left: auto;
    margin-right: auto;
}
body[data-page="admin-emergency"] .cm-hero { margin-bottom: 22px; }
body[data-page="admin-emergency"] .cm-emg-banner { min-height: 92px; box-sizing: border-box; }
body[data-page="admin-emergency"] #rollCallCard { overflow: hidden; }
@media (max-width: 680px) {
    body[data-page="admin-emergency"] .cm-emg-banner { align-items: flex-start !important; }
    body[data-page="admin-emergency"] #emgActionBtn { width: 100%; justify-content: center; }
}
.cm-emg-icon {
    width: 40px;
    height: 40px;

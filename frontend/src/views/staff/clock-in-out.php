...
<style>
.cm-clock-grid { display: grid; grid-template-columns: 1.1fr .9fr; gap: 20px; }
@media (max-width: 860px) {
    .cm-clock-grid { grid-template-columns: 1fr; }
    .cm-hero { flex-direction: column; align-items: flex-start; gap: 12px; }
}
#qrReader video {
    width: 100% !important;

...
<head>
    ...
    <style>
        :root { --navy:#152238; --ink:#172033; --muted:#778196; --line:#e8ebf1; --surface:#fff; --canvas:#f6f7fb; --primary:#5b5bd6; --primary-dark:#4747bb; --success:#16836a; --warn:#a55c10; --danger:#c4455a; }
        * { box-sizing:border-box; }
        body { margin:0; background:var(--canvas); color:var(--ink); font-family:"DM Sans",sans-serif; }
        .attendance-page { margin-left:260px; min-height:100vh; padding:42px 48px; }
        ...
        .summary-icon { align-items:center; background:#efefff; border-radius:11px; color:var(--primary); display:flex; flex:0 0 42px; height:42px; justify-content:center; }
        ...
        .field input:focus { border-color:var(--primary); box-shadow:0 0 0 3px #5b5bd61a; }
        ...
        .avatar { align-items:center; background:#eaecff; border-radius:50%; color:var(--primary); display:inline-flex; font-size:.72rem; height:31px; justify-content:center; width:31px; }
        ...
        .empty-icon { align-items:center; background:#f1f2ff; border-radius:50%; color:var(--primary); display:flex; height:42px; justify-content:center; margin:0 auto 10px; width:42px; }
        ...
        .admin-avatar { align-items:center; background:#7139df; border-radius:50%; color:#fff; display:flex; font-weight:700; height:42px; justify-content:center; width:42px; }
